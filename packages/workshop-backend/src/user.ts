...
export class UserDurableObject extends DurableObject<Cloudflare.Env> {
  ...
  /**
   * Internal compatibility lookup for bindings written before they stored a stable profile ID. It
   * searches only this user's own records and returns a result only when the legacy provider
