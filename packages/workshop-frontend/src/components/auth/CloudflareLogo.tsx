// Official Cloudflare logomark (multicolor). Brand asset, kept as a component so it can be sized
// like the Phosphor icons used elsewhere. Source: Cloudflare brand SVG (CF_logomark.svg).
